...
u=twcr.load('uwnd.10m',year,month,day,hour,version='2c')
ue=u.extract(iris.Constraint(member=member))
v=twcr.load('vwnd.10m',year,month,day,hour,version='2c')
